...
class ternsOfUsePage extends StatefulWidget {
  const ternsOfUsePage({Key? key}) : super(key: key);

  @override
  State<ternsOfUsePage> createState() => _ternsOfUsePageState();
}

class _ternsOfUsePageState extends State<ternsOfUsePage> {
  @override
  List<String> colms = [
    '第1条（適用）',
    '第2条（利用登録）',
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return Container(
            ...
            child: Column(
              children: [
                Text(colms[index],style: TextStyle(fontWeight: FontWeight.bold),),
                Text(Kiyaku[index])
              ],
            ),
          );
